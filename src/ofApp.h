...
public:
    ...
    float radialNoiseDemoR;
    float radialNoiseDemoR1;
    float radialNoiseDemoR2;
    float radialNoiseDemoR3;
     float radialNoiseDemoR4;
     float radialNoiseDemoR5;
        float radialNoiseDemoR0;
       float radialNoiseDemoR6;
       float radialNoiseDemoR7;
    float radialNoiseDemoR8;
